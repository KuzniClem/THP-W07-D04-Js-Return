...
console.log(entrepreneurs.map(entrepreneur => new Date().getFullYear() - entrepreneur.year));

console.log(entrepreneurs.sort((a, b) => a.last.localeCompare(b.last, 'en', {'sensitivity': 'base'})));
